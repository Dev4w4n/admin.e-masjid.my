...
INSERT INTO tenant (name_space, db_host, db_user, db_password, db_name, allowed_origin, manager_role, user_role, keycloak_client_id, keycloak_server, keycloak_jwks_url)
VALUES
